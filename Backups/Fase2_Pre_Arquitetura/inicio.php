...
<body>
    ...
    <div class="sidebar shadow">
        <div class="list-group list-group-flush p-3">
            ...
            <a href="criar_proposta_dinamica.php?nova=1" class="list-group-item list-group-item-action list-group-item-dark">
                ...
                <div class="col-md-6 mb-4">
                    <div class="card h-100 shadow-sm">
                        <div class="card-body text-center d-flex flex-column justify-content-center p-4">
                            ...
                            <a href="criar_proposta_dinamica.php?nova=1" class="btn btn-success btn-lg mb-2">
                                🚀 Criar Nova Proposta
                            </a>
