...
<body>
    ...
    <div class="container mt-4 mb-5">
        ...
        <form action="salvar_edicao_proposta.php" method="POST" id="form-proposta">
            ...
            <div class="text-center py-4">
                <button type="submit" class="btn btn-outline-warning btn-lg px-5 shadow-lg fw-bold text-dark" id="btn-salvar-normal">
                    <i class="bi bi-check2-square me-2"></i> Salvar Altera��ões
                </button>
                <button type="button" class="btn btn-success btn-lg px-5 shadow-lg fw-bold ms-3" id="btn-salvar-editor" onclick="salvarIrEditor()">
                    <i class="bi bi-magic me-2"></i> Salvar e Ir para Editor Dinâmico
                </button>
            </div>
        </form>
    </div>
    ...
    <!-- Função para salvar e ir ao editor -->
    <script>
        function salvarIrEditor() {
            // Adiciona flag para redirecionar
            $('<input>').attr({type: 'hidden', name: 'redirect_to_editor', value: '1'}).appendTo('#form-proposta');
            // Desabilita botão
            $('#btn-salvar-editor').prop('disabled', true).html('<span class="spinner-border spinner-border-sm me-2"></span>Salvando...');
            // Submete
