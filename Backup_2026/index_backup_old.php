...
<body
    ...
    <main>
        ...
        <section id="inicio" class="min-h-screen flex items-center pt-32 pb-20 relative">
            ...
            <div class="absolute top-1/4 right-1/4 w-96 h-96 bg-blue-600/20 rounded-full blur-[128px]"></div>
            <div class="absolute bottom-1/4 left-1/4 w-96 h-96 bg-brand-accent/10 rounded-full blur-[128px]"></div>

            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-12 items-center relative z-10">

                <!-- [LEFT COLUMN] Área do Vídeo / Preview (Carousel) -->
                <!-- Movido para a esquerda conforme solicitado -->
                <div class="relative group perspective-1000 mt-8 lg:mt-0 order-2 lg:order-1" id="video">
                    <!-- Moldura decorativa -->
                    <div
                ...
                <!-- [RIGHT COLUMN] Texto e Botões -->
                <div class="space-y-8 animate-float text-center lg:text-left order-1 lg:order-2">
                    <h1 class="font-display text-4xl sm:text-5xl lg:text-7xl font-bold text-white leading-tight">
                        <span class="brand-highlight text-transparent bg-clip-text bg-gradient-to-r from-brand-accent via-orange-400 to-orange-300 whitespace-nowrap">SGT-Propostas</span>
                        <br>
                        <span class="text-3xl sm:text-4xl lg:text-5xl text-blue-100">Gestão de Prosperidade</span>
                    </h1>

                    <p class="text-base sm:text-lg text-slate-300 max-w-xl mx-auto lg:mx-0 leading-relaxed">
                        Sistema integrado ao MySQL, seguro e acessível. Transforme leads em contratos fechados com nossa solução SaaS.
                    </p>

                    <!-- GRID DE BOTÕES PEDIDOS -->
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        
                        <!-- Coluna 1: Acessos -->
                        <div class="space-y-3">
                            <span class="text-xs uppercase font-bold text-slate-500 tracking-wider">Já sou cliente</span>
                            
                            <!-- Botão Cliente PRO -->
                            <a href="login_prod.php" 
                               class="block w-full px-6 py-4 bg-gradient-to-r from-blue-900 to-blue-800 hover:from-blue-800 hover:to-blue-700 text-white font-bold rounded-xl shadow-lg border border-blue-700/50 flex items-center justify-center gap-3 transition-all hover:scale-[1.02]">
                                <i class="ph ph-crown text-xl text-yellow-400"></i>
                                Login Cliente PRO
                            </a>

                            <!-- Botão Cliente DEMO -->
                            <a href="login_demo.php" 
                               class="block w-full px-6 py-4 bg-white/5 hover:bg-white/10 text-white font-bold rounded-xl shadow-lg border border-white/10 flex items-center justify-center gap-3 transition-all hover:scale-[1.02]">
                                <i class="ph ph-test-tube text-xl text-yellow-400"></i>
                                Login Demonstração
                            </a>
                        </div>

                        <!-- Coluna 2: Novos Clientes -->
                        <div class="space-y-3">
                            <span class="text-xs uppercase font-bold text-slate-500 tracking-wider">Quero conhecer</span>

                            <!-- Solicitar Demonstração / Cadastrar -->
                            <a href="criar_conta_demo.php" 
                               class="block w-full px-6 py-4 bg-brand-accent hover:bg-brand-action text-white font-bold rounded-xl shadow-lg shadow-orange-600/20 border border-orange-500/20 flex items-center justify-center gap-3 transition-all hover:scale-[1.02]">
                            ...
                            <!-- Adquirir Plano PRO -->
                            <a href="#planos" 
                               class="block w-full px-6 py-4 bg-green-600 hover:bg-green-500 text-white font-bold rounded-xl shadow-lg shadow-green-600/20 border border-green-500/20 flex items-center justify-center gap-3 transition-all hover:scale-[1.02]">
                    ...
                    <div class="pt-6 border-t border-white/10 flex flex-wrap items-center justify-center lg:justify-start gap-4 text-slate-400 text-sm">
                        <div class="flex items-center gap-2"><i class="ph ph-database text-brand-glow"></i> MySQL</div>
                        <div class="flex items-center gap-2"><i class="ph ph-lock p-1 rounded bg-green-500/20 text-green-400"></i> Seguro</div>
                        <div class="flex items-center gap-2"><i class="ph ph-devices p-1 rounded bg-blue-500/20 text-blue-400"></i> Responsivo</div>
                    </div>
                </div>
