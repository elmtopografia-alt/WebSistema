//Seções ModificadasSubstitua o bloco de seleção de cliente (aproximadamente linhas 695-715)
<!-- STEP 1: CLIENTE - VERSÃO MOBILE CORRIGIDA -->
<div class="step-panel active" id="step-1">
    ...
    <div class="form-row cols-2">
        <!-- Cliente com botão Novo - Layout responsivo corrigido -->
