...
// Função: Tela de sucesso. Inicia download e redireciona para FINAL.PHP (Vendas).
...
// Se for Demo -> Vai para final.php (Tentar Vender)
// Se for Prod -> Vai para painel.php (Continuar trabalhando)
$url_destino = $is_demo ? 'final.php' : 'painel.php';

// DICA: Se você quiser testar a página final mesmo sendo Admin, descomente a linha abaixo:
...
<head>
    ...
    <style>
        ...
        .btn-download { 
            ...
            text-decoration: none; color: white; display: inline-block; width: 100%;
        }
...
<body>
    ...
    <div class="card card-success bg-white">
        ...
        <?php if($arquivoExiste): ?>
            ...
            <div class="d-grid gap-3">
                <!-- BOTÃO DE DOWNLOAD -->
                <!-- O 'onclick' dispara o redirecionamento -->
        ...
        <?php else: ?>
            <div class="alert alert-warning">
                O arquivo foi gerado, mas não encontrado na pasta.
            </div>
    ...
    <script>
        function irParaVenda() {
            // Espera 2 segundos (2000ms) para o download iniciar e o usuário ver a animação
            // Depois muda a página para a oferta de venda
            setTimeout(function() {
