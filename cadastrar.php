...
// Função: Tela de Planos com Link PIX Realçado (Azul e Negrito).
...
// 2. Link de PAGAMENTO ÚNICO R$ 30,00 (PIX Avulso) - Insira o link gerado abaixo
...
<head>
    ...
    <style>
        ...
        .pix-link:hover { 
            text-decoration: none; 
            color: #0043a8; /* Azul mais escuro no hover */
            background-color: #f0f8ff; /* Fundo azulzinho leve para destacar */
            border-radius: 5px;
        }
        ...
        <div class="row row-cols-1 row-cols-md-2 row-cols-xl-4 g-3 justify-content-center">
            ...
            <div class="col">
                <div class="card-plan p-3 text-center">
                    ...
                    <!-- Opção Secundária: PIX Avulso (REALÇADA) -->
