...
class ModeloPropostaDrone 
{
    const NOME = 'PropostaDrone';
...
',
  ...
  36 => 'whatsapp_salvo',
        ...
        /* Títulos com cores alternadas - Azul, Marrom, Cinza */
        .modelo-docx h1 { 
            color: #1e3a8a; 
        ...
        /* Seção 4 (Metodologia) - Azul escuro */
    ...
    {
        // PULAR BLOCOS SEM CONTEÚDO
        if (empty(trim($bloco['conteudo'] ?? ''))) {
            return "";
        }
